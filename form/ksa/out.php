 ...
 <!--php-->
  ...
  function msg() {
   ...
   if (isset($_POST["submit"])) {
    ...
    #file
     echo "<!--file-->"; print("\n ");
      echo '<div style="display:none" class="file">'; print("\n");
       echo '<i id="x" title="إغلاق" class="fas fa-times"></i>'; print("\n");
       echo "<span>"; print("\n");
        echo "<p>".'للأسف لم تتم عملية النسخ بنجاح، الرجاء تحميل الرسالة وإرسالها على <a href="https://api.whatsapp.com/send?phone=201559003611" target="_blank"><i class="fab fa-whatsapp"></i> الواتساب</a>'."</p>"; print("\n");
        echo "<a href=\"$file\" id=\"dwn\" download><button type=\"button\">".'تحميل الرسالة كملف نصي <i class="fas fa-file-download"></i>'."</button></a>"; print("\n");
       echo "</span>";
      echo '</div>';
